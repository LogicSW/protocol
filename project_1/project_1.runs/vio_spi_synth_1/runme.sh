...
HD_PWD='C:/Users/Rp/Desktop/digital_project/Protocol/project_1/project_1.runs/vio_spi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_spi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_spi.tcl
