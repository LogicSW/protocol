...
HD_PWD='C:/Users/Rp/Desktop/Homework/Homework/uart_hello/uart_hello/uart_hello.runs/ila_uart_hello_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_uart_hello.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_uart_hello.tcl
