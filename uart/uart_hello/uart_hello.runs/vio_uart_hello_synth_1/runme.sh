...
HD_PWD='C:/Users/Rp/Desktop/Homework/Homework/uart_hello/uart_hello/uart_hello.runs/vio_uart_hello_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_uart_hello.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_uart_hello.tcl
