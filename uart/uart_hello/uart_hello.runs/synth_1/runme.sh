...
HD_PWD='C:/Users/Rp/Desktop/Homework/Homework/uart_hello/uart_hello/uart_hello.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_hello.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_hello.tcl
