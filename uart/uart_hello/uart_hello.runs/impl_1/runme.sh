...
HD_PWD='C:/Users/Rp/Desktop/Homework/Homework/uart_hello/uart_hello/uart_hello.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_hello.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_hello.tcl -notrace
